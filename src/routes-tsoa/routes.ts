...
const models: TsoaRoute.Models = {
  ...
  OrderItem: {
    dataType: 'refObject',
    properties: {
      product_id: { dataType: 'double', default: 0 },
      quantity: { dataType: 'double', default: 1 },
    },
    additionalProperties: false,
  },
  // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
  CreateOrderBody: {
    dataType: 'refObject',
    properties: {
      customer: { dataType: 'string', default: '' },
      total: { dataType: 'double', default: 0.01 },
      items: { dataType: 'array', array: { dataType: 'refObject', ref: 'OrderItem' }, default: [] },
    },
    additionalProperties: false,
  },
  // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
  ...
  OrderWithItems: {
    ...
    properties: {
      ...
      items: {
        dataType: 'array',
        array: { dataType: 'refObject', ref: 'OrderItemDetails' },
        required: true,
      },
    },
    additionalProperties: false,
...
export function RegisterRoutes(app: Router) {
  ...
  app.get(
    ...
    async function ProductsController_getRemoteProducts(
      request: ExRequest,
      response: ExResponse,
      next: any,
    ) {
      ...
      try {
        validatedArgs = templateService.getValidatedArgs({
          args: argsProductsController_getRemoteProducts,
          request,
          response,
        });
  ...
  app.get(
    ...
    async function ProductsController_getLocalProducts(
      request: ExRequest,
      response: ExResponse,
      next: any,
    ) {
      ...
      try {
        validatedArgs = templateService.getValidatedArgs({
          args: argsProductsController_getLocalProducts,
          request,
          response,
        });
  ...
  app.post(
    ...
    async function ProductsController_syncProducts(
      request: ExRequest,
      response: ExResponse,
      next: any,
    ) {
      ...
      try {
        validatedArgs = templateService.getValidatedArgs({
          args: argsProductsController_syncProducts,
          request,
          response,
        });
  ...
  app.post(
    ...
    async function OrdersController_createOrder(
      request: ExRequest,
      response: ExResponse,
      next: any,
    ) {
      ...
      try {
        validatedArgs = templateService.getValidatedArgs({
          args: argsOrdersController_createOrder,
          request,
          response,
        });
  ...
  app.get(
    ...
    async function OrdersController_getOrders(request: ExRequest, response: ExResponse, next: any) {
      ...
      try {
        validatedArgs = templateService.getValidatedArgs({
          args: argsOrdersController_getOrders,
          request,
          response,
        });
  ...
  app.get(
    ...
    async function HelloController_getHello(request: ExRequest, response: ExResponse, next: any) {
      ...
      try {
        validatedArgs = templateService.getValidatedArgs({
          args: argsHelloController_getHello,
          request,
          response,
        });
